...
module.exports = React.createClass({displayName: "exports",
	render: function() {
		...
		switch (req){
		case "form": 
			body = React.createElement(Form, {data: data});
			break;
		case "products": 
...
var LogoutButton = React.createClass({displayName: "LogoutButton",
	...
	render: function() {
		return (
				React.createElement("button", {className: "button", onClick: this.clickHandler}, "Logout")
				)
	}
});
...
var LoginButton = React.createClass({displayName: "LoginButton",
	...
	render: function() {
		return (
				React.createElement("button", {className: "button", onClick: this.clickHandler}, "Login")
				)
	}
});
