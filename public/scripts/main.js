...
var TodoList = React.createClass({displayName: "TodoList",
	render: function() {
		...
		var createItem = function(itemText) {
			return React.createElement("li", {key: i++}, itemText);
		};
...
var TodoApp = React.createClass({displayName: "TodoApp",
	...
	render: function() {
		return (
				...
				React.createElement("button", {className: "btn btn-primary"}, 'Add #' + (this.state.items.length + 1))
				)
				)
				);
	}
